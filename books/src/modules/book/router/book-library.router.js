...
const { viewIndexBook, viewBook, viewAddBook, viewBookDelete, viewAddBookPost, viewUpdateBook, viewUpdateBookPost, viewGetCounter } = require('../controller/book-view.controller');
